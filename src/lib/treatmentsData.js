export const slugData = {
  ...
  "arthritis-treatment": {
    ...
    risks: {
      ...
      items: [
        { text: "Age", img: "/images/age.png" },
        { text: "Obesity", img: "/images/weight.png" },
        { text: "Family History", img: "/images/physic.png" },
        { text: "Joint Injuries", img: "/images/yoga.png" },
        { text: "Lack of Exercise", img: "/images/exercise.png" },
        { text: "Smoking", img: "/images/smoke.png" },
      ],
      videoSection: {
        heading: "Arthritis Treatment Explained",
        subtext:
          "Our senior Ayurvedic physician explains how Panchakarma tackles arthritis at its root.",
        image: "/images/doctor.png",
      },
    },
    conditionDetail: {
      ...
      heading: "Arthritis",
      description:
        "Arthritis is the inflammation of one or more joints, causing pain, stiffness, and reduced range of motion. There are over 100 types of arthritis, with osteoarthritis and rheumatoid arthritis being the most prevalent. In Ayurveda, arthritis is primarily classified under 'Sandhivata' (osteoarthritis) and 'Amavata' (rheumatoid arthritis) — conditions caused by the aggravation of Vata dosha and accumulation of Ama (toxins) in the joints. Ayurvedic treatment targets these root causes through detoxification, rejuvenation, and customised lifestyle guidance to bring lasting relief.",
    },
    causes: {
      heading: "Causes",
      items: [
        {
          ...
          description:
            "Cartilage is a firm, flexible connective tissue that protects joints. In osteoarthritis, the cartilage breaks down over time due to wear and tear, age, injury, or obesity. Without sufficient cartilage, bone grinds against bone during movement, causing pain, swelling, and stiffness.",
        },
        {
          icon: "Activity",
          title: "Autoimmune Reaction",
          description:
            "In rheumatoid arthritis, the body's immune system mistakenly attacks the synovial membrane lining the joints. This chronic inflammation gradually erodes cartilage and bone, causing deformity and functional loss if not treated promptly.",
        },
      ],
    },
    medicalAttention: {
      ...
      items: [
        {
          icon: "TrendingUp",
          title: "Rapid Joint Swelling",
          description:
            "Sudden, severe swelling in any joint — especially with redness and warmth — may indicate septic arthritis or a gout flare requiring urgent medical evaluation.",
        },
        {
          icon: "Droplets",
          title: "Fever with Joint Pain",
          description:
            "Joint pain accompanied by fever, fatigue, and weight loss can be a sign of rheumatoid arthritis or an underlying systemic infection.",
        },
        {
          icon: "Syringe",
          title: "Significant Loss of Mobility",
          description:
            "If joint stiffness or pain prevents normal daily activities such as walking, gripping, or climbing stairs, immediate consultation is recommended.",
        },
      ],
    },
    prevention: {
      ...
      items: [
        {
          ...
          text: "Swimming, yoga, and walking strengthen the muscles around joints without placing excessive stress on them.",
        },
        {
          icon: "HeartPlus",
          title: "Maintain Healthy Weight",
          text: "Every extra kilogram of body weight puts 4x more pressure on knee joints — keeping weight in check reduces arthritis risk significantly.",
        },
        {
          icon: "Droplets",
          title: "Anti-Inflammatory Diet",
          text: "A diet rich in omega-3 fatty acids, turmeric, ginger, and fresh vegetables helps control systemic inflammation.",
        },
        {
          icon: "Cigarette",
          title: "Avoid Smoking",
          text: "Smoking is a proven risk factor for rheumatoid arthritis and worsens disease progression in existing patients.",
        },
      ],
    },
    causeCards: {
      heading: "What's Causing Your Arthritis?",
      items: [
        {
          label: "Ama (Toxins)",
          subtext:
            "How does Ayurveda explain the role of toxin accumulation in arthritis?",
        },
        ...
        { label: "Joint Injury" },
        { label: "Genetics" },
        { label: "Sedentary Life" },
        { label: "Autoimmunity" },
      ],
    },
    treatments: {
      heading: "Arthritis Treatments in Ayurveda",
      items: [
        { title: "Virechana", desc: "(Therapeutic purgation to eliminate Ama)" },
        { title: "Vasti", desc: "(Medicated enema to pacify Vata)" },
        { title: "Abhyanga", desc: "(Warm medicated oil massage)" },
        { title: "Swedana", desc: "(Herbal steam therapy)" },
        { title: "Janu Vasti", desc: "(Oil pooling over knee joints)" },
        { title: "Lepanam", desc: "(Application of herbal anti-inflammatory paste)" },
        { title: "Pizhichil", desc: "(Warm oil bath for joint nourishment)" },
        { title: "Rasayana", desc: "(Rejuvenation and immune-modulation therapy)" },
      ],
    },
    ourTreatments: {
      heading: "Our Treatment",
      ...
      cards: [
        { title: "Rheumatoid Care", img: "treatment1.png" },
        { title: "Osteoarthritis", img: "treatment2.png" },
        { title: "Joint Rehabilitation", img: "treatment3.png" },
        { title: "Gout Management", img: "treatment4.png" },
        { title: "Panchakarma", img: "treatment1.png" },
        { title: "Pain Relief", img: "treatment2.png" },
      ],
    },
    faqs: {
      heading: "Frequently asked questions",
